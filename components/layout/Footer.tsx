...
const resourceLinks = [
  ...
  { href: '/contact#booking', label: 'Book a Free Call' },
]

const socialLinks = [
  {
    href: 'https://linkedin.com/company/healthsng',
    label: 'LinkedIn',
    icon: (
  ...
  {
    href: 'https://twitter.com/healthsng',
    label: 'Twitter / X',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4" aria-hidden="true">
  ...
  {
    href: 'https://instagram.com/healthsng',
    label: 'Instagram',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4" aria-hidden="true">
  ...
  {
    href: 'https://facebook.com/healthsng',
    label: 'Facebook',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4" aria-hidden="true">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 text-white/70 text-sm leading-relaxed max-w-sm">
              Nigeria&apos;s health media and digital empowerment platform — helping healthcare
              professionals grow their practice and making trusted health knowledge accessible
              to every Nigerian.
            </p>
            ...
            <div className="mt-6 flex items-center gap-3">
              {socialLinks.map(({ href, label, icon }) => (
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label={label}
                  className="w-8 h-8 rounded-lg bg-white/10 hover:bg-brand-teal flex items-center justify-center transition-colors text-white/70 hover:text-white"
                >
                  {icon}
                </a>
              ))}
          ...
          <div>
            ...
            <div className="mt-6">
              <p className="text-white/50 text-xs mb-2">Ready to grow?</p>
              <Link
